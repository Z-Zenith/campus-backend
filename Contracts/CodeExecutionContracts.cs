...
// job is mapping it onto DockerCodeRunner (a per-submission `docker run`, see that class's
...
// compile-run commands (see DockerCodeRunner.Languages). Every other file is written to the
...
// Status is one of DockerCodeRunner.ClassifyRunResult's four buckets ("accepted" |
